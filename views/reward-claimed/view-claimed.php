            ...
            <div class="card-header" id="headingOne<?= $index ?>">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-10">
                        ...
                        <h6 class="text-muted text-uppercase mt-0"><?= $model->getIdTrx() ?></h6>
                    </div>
            ...
            <div id="collapseOne<?= $index ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion<?= $index ?>">
                <div class="card-box tilebox-one">
                    <div class="row" style="display: flex;">
                        <h6 class="col-3 offset-md-1">Reward</h6>
                        <h6 class="col-6 text-muted">
                            <?php for ($i = 0; $i < $reward->rating; $i++) { ?>
                                <i class="icon-star float-left m-0 h4 text-warning"></i>
                            <?php } ?>
                        </h6>
                    </div>
                    <div class="row" style="display: flex;">
                    ...
                    <div class="row" style="display: flex;">
                        ...
                        <h6 class="col-6 text-muted">Reward</h6>
                    </div>
                    <div class="row" style="display: flex;">
                        <h6 class="col-3 offset-md-1">Total</h6>
                        <h6 class="col-6 text-muted">IDR. <?= number_format(@$reward->type, 0, ",", ".") ?></h6>
                    </div>
                    <div class="row">
