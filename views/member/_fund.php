            ...
            <div id="collapseOne<?= $index ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion<?= $index ?>">
                <div class="card-box tilebox-one">
                    ...
                    <div class="row" style="display: flex;">
                        ...
                        <h6 class="col-6 text-muted"><?= $model->fundRef->keterangan ?></h6>
                    </div>
                    <div class="row" style="display: flex;">
                        <h6 class="col-3 offset-md-1">Referensi</h6>
                        <?php $referrensi = @$model->member->nama;
                        if ($model->id_fund_ref == FundRef::ROI or $model->id_fund_ref == FundRef::CASHBACK) {
                            $referrensi = 'System';
                        }
                        ?>
                        <h6 class="col-6 text-muted"><?= $referrensi ?></h6>
                    </div>
                    <div class="row" style="display: flex;">
