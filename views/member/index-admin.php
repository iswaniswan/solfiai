...
<div class="row mb-4">
    <div class="container-fluid">
        <div class="dt-button-wrapper">
            <?= Html::a('<i class="ti-list mr-2"></i> Semua', ['index-admin'], ['class' => 'btn btn-primary mb-1']) ?>
                ...
                [
                    ...
                    [
                     ...
                     [
                         ...
                         'template' => '{view} {update} {delete} {password} {pin}',
                         'visibleButtons' => ['view' => false, 'update' => false, 'delete' => false, 'password' => true, 'pin' => true],
                         'buttons' => [
                             ...
                             'password' => function ($url, $model) {
                                 return Html::a('<i class="ti-key"></i>', ['member/admin-update-security', 'id' => @$model->id], [
                                         'title' => 'Update Password', 'data-pjax' => '0',
