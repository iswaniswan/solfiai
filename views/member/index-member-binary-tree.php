...
<div class="row mb-4">
    <div class="container-fluid">
        ...
        <div class="downline-index card card-nav-tabs" style="width: fit-content">
            <div class="card-header card-header-warning text-left" style="padding:unset">
            </div>
            <div class="card-body" style="height: 600px; border-radius: 1rem; border: 2px solid rgb(187, 187, 187); width: 99%; overflow-x: scroll; overflow-y: hidden" id="chart-binary">
                <div style="float:right; position: absolute; right: 4rem">
