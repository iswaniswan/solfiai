        ...
        <div class="card-box">
            <div class="card-body row">
                ...
                <div class="container info-withdraw">
                    <span>Minimal 10% dari nilai paket.</span>
                    <span>80% tunai & 20% tabungan.</span>
                    <span>Dilakukan setiap hari kerja (senin - jumat) pukul 08.00 - 17.00 WIB.</span>
                    <span>Dana hasil withdraw ditransfer max pukul 20.00 WIB dihari yang sama.</span>
                    <span>Pengisian nama dan no rekening harus sesuai dengan yang didaftarkan.</span>
                </div>
            </div>
        </div>
    </div>
